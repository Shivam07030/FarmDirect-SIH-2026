            ...
            <form onSubmit={handleConfirmPurchase} className="space-y-4">
              ...
              <div>
                ...
                <div className="flex items-center">
                  <button
                    type="button"
                    onClick={() => setPurchaseQuantity((q) => Math.max(10, q - 25))}
                    className="px-3 py-2.5 border border-r-0 border-stone-200 bg-stone-50 rounded-l-xl text-stone-700 font-bold text-sm cursor-pointer"
                  >
                    -
                  </button>
                  <input
                    ...
                    className="w-full text-center py-2.5 border-y border-stone-200 text-sm focus:outline-none"
                  />
                  <button
                    type="button"
                    onClick={() => setPurchaseQuantity((q) => Math.min(selectedProduct.quantity, q + 25))}
                    className="px-3 py-2.5 border border-l-0 border-stone-200 bg-stone-50 rounded-r-xl text-stone-700 font-bold text-sm cursor-pointer"
                  >
                    +
                  </button>
                </div>
